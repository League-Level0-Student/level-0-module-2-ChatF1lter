...
public class StringsCannotAdd {
	...
	String quantity2 = JOptionPane.showInputDialog("Enter the number 6");		
	...
	String quantity3 = JOptionPane.showInputDialog("Enter the number 5");		
	...
	int sixAsInt = Integer.parseInt(quantity2);
	...
	int fiveAsInt = Integer.parseInt(quantity3);		
