...
public class AnimalFarm {
	...
	void animals() {
		 ...
		 */			 
		for(int n=0;n<5;n++) {
			String question = JOptionPane.showInputDialog(null, "Which animal do you want: cat,cow,dog,duck,or llama? (Will repeat a few times, put a new animal in each one)");	
